...
<?php
  ...
  if(isset($_POST['checkout_form']))
  {
    ...
    $encryption = openssl_encrypt($_SESSION['sellerdomain'],$ciphering,$encryption_key, $options, $encryption_iv);

    $data['sellerdomain']=$encryption;
    ...
    if(isset($output['checkout']) && $output['checkout']['response_code']==200 && $output['checkout']['order_type']=="COD")
    {
        ...
        redirect("displayCustomerOrderConfirmation.php?orderplaced=1");
    }
    else
    {
      $showinformation=1;
...
?>
  ...
  <nav class="navbar navbar-light fixed-bottom pl-5 bg-primary">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a href="cartdetails.php" class="btn btn-sm bg-transparent border-0 text-white">
          <?php 
            if(count($_SESSION['cartdetails'])>0)
              echo "<span class='bp-nv-cartcount'>".count($_SESSION['cartdetails'])."</span>";
            else
              echo "<span class='bp-nv-cartcount'>0</span>";
          ?>
    ...
    <div class="container-fluid mb-5">
      <div class="row mt-3">
        <div class="col-12">
          <a href="<?php echo DOMAIN; ?>/app/?s=<?php if(isset($_SESSION['sellerdomain'])) echo $_SESSION['sellerdomain']; ?>" class="btn btn-success" id="home-btn">Back To Products</a>
        </div>
      </div>
      <!-- Heading -->
      <div class="row mt-5">
            ...
            <div class="bp-cart">
              ...
              <div class="row">
                ...
                <div class="col-6 text-right">
                  <h4><span class="badge badge-secondary badge-pill"><?php echo count($_SESSION['cartdetails']); ?></span></h4>
                </div>
              </div>
            ...
            <div class="row mt-3">
              <div class="col-12">
               <div class="card mb-5">
                ...
                ?>
                 <!--Card content-->
                  <form class="card-body" method="post" action="" autocomplete="on">
                      ...
                      <div class="bp-checkoutform-col">
                        <div class="form-group">
                          <label for="state">State</label>
                           <select class="custom-select d-block w-100" name="state" id="state" required value="
                           <?php 
                      ...
                      <div class="col-12 mt-1">
                        <div class="form-group">
                          ...
                          <div class="row ml-1 mr-1">
                            <?php
                                if(isset($_SESSION['sellerdomain_kyc_completed']) && $_SESSION['sellerdomain_kyc_completed']==1 && isset($_SESSION['sellerdomain_accept_online_payments']) && $_SESSION['sellerdomain_accept_online_payments']==1)
                                {
                            ?>
                            ...
                            <?php
                              ...
                              if(isset($_SESSION['sellerdomain_accept_cod_payments']) && $_SESSION['sellerdomain_accept_cod_payments']==1)
                              {
                            ?>
  ...
  <div class="container">
    <div class="row text-center mt-5">
      ...
      <div class="col-12 text-danger mt-5">
        <a href="<?php echo DOMAIN; ?>/app/?s=<?php if(isset($_SESSION['sellerdomain'])) echo $_SESSION['sellerdomain']; ?>" class="btn btn-primary">Back To Products</a>
      </div>
    </div>
  </div>
<?php
