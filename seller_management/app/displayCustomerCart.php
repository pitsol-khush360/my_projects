...
if(isset($_REQUEST['s']))
{
  ...
  if(isset($_REQUEST['s']) && isset($_SESSION[$_REQUEST['s']]['sellerdomain']))
    $sdurl=DOMAIN.'/app/displayCustomerCart.php?s='.$_SESSION[$_REQUEST['s']]['sellerdomain'];
...
?>
  ...
  <nav class="navbar navbar-light fixed-bottom pl-3 pl-md-5 bg-primary">
    ...
    <div class="container-fluid mb-5">
      <div class="row mt-3">
        <div class="col-12">
          <a href="<?php echo DOMAIN; ?>/app/?s=<?php if(isset($_SESSION[$_REQUEST['s']]['sellerdomain'])) echo $_SESSION[$_REQUEST['s']]['sellerdomain']; ?>" class="btn btn-success ml-0 ml-lg-3" id="home-btn">Back To Products</a>
        </div>
      </div>
      <!-- Heading -->
      <div class="row mt-5">
        ...
        <div class="row mt-4 pl-lg-3 pr-lg-3">
                    ...
                    <li class="list-group-item">
                     <div class="row item">
                       <div class="col-4 pl-0 pr-0">
                        <img class="img-fluid cart-list-img" src="..<?php echo $value['product_image']; ?>">
                       </div>
                       <div class="offset-md-1 col-7">
                                ...
                                <div class="row">
                                  <div class="col-3 col-lg-2">
                                   ...
                                   <div class="col-5 col-lg-3">
                                    <div class="border border-secondary text-center mt-1"><?php echo $value['quantity']; ?></div>
                                  </div>
                           ...
                           <div class="row mt-3 bp-nml-text">
                            <div class="col-3 col-md-5"><b>Net Price</b></div>
                            <div class="col-9 col-md-7 text-right"><i class="fas fa-rupee-sign text-muted"></i>&nbsp;<?php echo $value['price']; ?>&nbsp;<i class="fa-lg">&times;</i>&nbsp;<?php echo $value['quantity']; ?></div>
                           </div>
                           <div class="row mt-2 bp-nml-text">
                            <div class="col-12 text-right"><i class="fas fa-rupee-sign text-muted"></i>&nbsp;<?php echo $value['price'] * $value['quantity'] ; ?></div>
                            </div>
                          <?php 
           ...
           <form action="" method="post" class="card p-2">
             <div class="input-group">
               ...
               <div class="input-group-append">
                 <input type="submit" name="apply_promocode" class="btn btn-success bg-success btn-md waves-effect m-0" value="Apply">
               </div>
             </div>
           </form>
          </div>
              ...
              <div class="col-12 mb-3">
               <div class="card mb-4">
                ...
                ?>
                  ...
                  <form class="card-body" method="post" action="<?php echo $sdurl; ?>" autocomplete="on" id="c-form">
                          ...
                          <div class="input-group">
                           ...
                           value="<?php 
                            if(isset($customer_prev_address) && isset($customer_prev_address['customer_address']['customer_mobile']))
                              ...
                              echo ""; ?>" required minlength="10" maxlength="10" pattern="[5-9]{1}[0-9]{9}" title="Enter Valid 10 Digit Mobile Number">
                         </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="row ml-1 mr-1">
                            <?php
                                ...
                                {
                            ?>
                            <div class="col-8 col-md-8 pl-0 pr-0 mt-3">
                            ...
                            <?php
                              ...
                              {
                            ?>
                            <div class="col-4 pl-0 pr-0 col-md-4 mt-3">
                              <div class="form-check-inline">
                                <label class="bp-nml-text">
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        ?>
                        <button type="button" class="btn btn-primary btn-lg btn-block" id="checkout-btn">Checkout</button>
                        <button type="submit" class="btn btn-primary btn-lg btn-block d-none" name="checkout_form" id="main-checkout-btn">Main Checkout</button>
                      </div>
                    </div>
                  </form>
                </div>
...
<div class="modal fade" id="otp-modal" tabindex="-1" role="dialog" aria-labelledby="otpModal" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="otpModal">OTP Verification</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
               </button>
           </div>
           <div class="modal-body">
              <div class="row">
                <div class="col-12">
                 <form class="bg-white" action='displayCustomerCart.php' method='post'>
                    <div class="row mt-2">
                      <div class="col-12 text-center">
                        Enter 4 digit OTP sent to your mobile number - <span id="c-mobile-for-otp"></span>
                      </div>
                    </div>
                    <div class="row mt-3">
                      <div class="col-12">
                       <div class="form-group row">
                           ...
                           <label class="form-check-label col-md-5 mt-2" for="c-otp">Enter OTP</label>
                           <div class="col-md-5">
                            <input type="text" name="c-otp" class="form-control" minlength="4" maxlength="4" id="c-otp">
                           </div>
                       </div>
                      </div>
                    </div>
                    <div class="row mt-2">
                     <div class="col-12 text-center">
                         <button type="button" class="btn btn-success" id="c-otp-submit">Confirm</button>
           ...
           <div class="modal-footer">
              <div class="row">
                <div class="col-12">
                  <p id="information-for-otp-modal" class=" text-danger d-none"></p>
                </div>
              </div>
           </div>
       </div>
...
<script>
  $('input:radio[name=order_type]').click(
    ...
    $("#checkout-btn").on("click",
      function(){
        ordertype=$("input:radio[name='order_type']:checked").val();
        mobile=$("#mobile").val();
        ...
        if(mobile!="")
        {
          if(ordertype=="COD")
          {
            var tobesend = 'action=sendotp&mobile_number='+mobile;
            ...
            $.ajax({
              ...
              {   
                ...
                {
                  $("#c-mobile-for-otp").text(mobile);
                  $("#information-for-otp-modal").text("");
                  $("#c-otp").val("");
                  $("#otp-modal").modal('show');
                }
                else
                {
                  $('#information').html("<p class='text-danger'>Unable to send otp. Please try after some time!</p>");
                  $('#information-modal').modal('show');
                }
              }
            });
          ...
          if(ordertype=="online")
          {
            $("#main-checkout-btn").trigger('click');
          }
        }
    });

    $("#c-otp-submit").on("click",
      () => {
        otp=$("#c-otp").val();

        if(otp!="" && otp.length==4)
        {
          var tobesend = 'action=verifyotp&otp='+otp;
          ...
          $.ajax({
            ...
            {   
              ...
              {
                $("#information-for-otp-modal").removeClass("d-none");
                $("#information-for-otp-modal").text("Invalid OTP! Please Enter Valid OTP");
                $("#c-otp").focus();
              }
            }
          });
        ...
        {
          $("#information-for-otp-modal").removeClass("d-none");
          $("#information-for-otp-modal").text("Please Enter Valid 4 Digit OTP");
          $("#c-otp").focus();
        }
    });
</script>
